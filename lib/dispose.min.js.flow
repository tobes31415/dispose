/**
 * Flowtype definitions for dispose
 ...
 */
declare export function isDisposed(object: { [key: string]: any }): boolean;

/**
 * Disposes an object
 * @param object The object to be disposed
 */
declare export function dispose(object: { [key: string]: any }): void;
 ...
 */
declare export function onDispose(
 ...
 * @param object The object to subscribe to
 */
declare export function onDisposeDisposeRecursively(object: {
  [key: string]: any
}): void;
 ...
 */
declare export function onDisposeChain(
 ...
 */
declare export function assertNotDisposed(
  object: { [key: string]: any },
  message?: string
): void;
 ...
 */
declare export function createDisposeableFunctionWrapper<T: Function>(
  fnRef: T,
  message?: string,
  silent?: boolean
): T;
